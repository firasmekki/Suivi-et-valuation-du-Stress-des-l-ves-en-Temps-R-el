...
// Email de test - CHANGE CETTE ADRESSE PAR TON EMAIL OU CELUI DU PARENT
const to = 'test@gmail.com'; // Mets ici l'email à tester
...
<head>
    ...
    <title>Alerte Stress - Test Soutenance</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>Cher(e) <strong>Parent</strong>,</p>
        
        <p>Notre système de surveillance du stress a détecté une situation CRITIQUE nécessitant votre attention immédiate concernant votre enfant <strong>Élève Test</strong>.</p>
        
        <div class="alert-box">
            <h3>📊 Informations de surveillance</h3>
            <p><strong>Élève :</strong> Élève Test</p>
            <p><strong>Classe :</strong> 1ère SVT</p>
...
console.log('📤 Envoi d\'email d\'alerte pour la soutenance...');
console.log('📧 Destinataire:', to);

sendEmail(to, subject, html)
  .then(() => {
    console.log('✅ Email envoyé avec succès à :', to);
    console.log('🎯 Tu peux maintenant montrer cet email à ta soutenance !');
  ...
  .catch((err) => {
    ...
    console.log('\n🔧 Solutions possibles :');
    console.log('1. Vérifie que l\'email est correct');
